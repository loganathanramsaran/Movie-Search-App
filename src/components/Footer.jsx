export const Footer = () => {
    return (
      <section className="bg-green-300 border-t-4 border-gray-700">
        <div className="container mx-auto flex p-2  justify-evenly items-center gap-4">
          <div className="text-gray-700 font-semibold flex  items-center gap-4 flex-wrap justify-center">
            <span>Home</span>          
            <span>About Us</span>          
