  ...
  return (
    <nav className="bg-green-300 border-b-3 border-b-gray-600 sticky top-0 z-10">
      <div className="flex justify-between p-3">
        ...
        <div className=" sapce-x-6 hidden sm:flex">
          <Link
            className="px-2 py-1 rounded-lg font-semibold text-gray-700 text-lg hover:text-white hover:bg-green-500"
            to={"/"}
          >
            Home
          </Link>
          ...
          <Link className="px-2 py-1 rounded-lg font-semibold text-gray-700 text-lg hover:text-white hover:bg-green-500">
            Sign in
          </Link>
        </div>
      ...
      {isOpen &&(
        <div className="md:hidden flex flex-col text-center space-y-1 mb-1 ">
            <Link to={"/"} className="text-gray-700 font-bold w-full hover:text-white hover:bg-green-700" onClick={() => setIsOpen(false)}>Home</Link>
            <Link to={"/Movie"} className="text-gray-700 font-bold w-full hover:text-white hover:bg-green-700" onClick={() => setIsOpen(false)}>Movie</Link>
        </div>
      )}
    </nav>
  );
