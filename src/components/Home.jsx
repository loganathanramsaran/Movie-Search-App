...
function Home() {
  ...
  return (
    <div>
      <h1 className="text-center text-5xl px-3 pt-20 font-bold  ">
      ...
      <div className="search flex gap-10 h-50 justify-center items-center max-sm:flex-col">
        <input
          className="outline-none shadow-xl font-bold rounded-xl text-center text-green-700 border-3 border-green-400 hover:bg-green-100 max-md:w-[80%] w-100 h-12 "
          type="text"
          value={query}
        ...
        />
        <select
          className="outline-none shadow-xl font-bold rounded-xl border-3 border-green-400 hover:bg-green-100 text-center cursor-pointer text-green-700 h-12 w-40 max-md:w-30 "
          value={type}
      ...
      <div className="text-center mb-10 ">
        {loading && (
          <p className="mx-auto animate-spin h-8 w-8 border-4 border-[#ffa000] border-solid rounded-full border-t-transparent">
          {""}
          </p>
        )}
          ...
          <div key={movie.imdbID}>
            <div className="flex flex-col w-50 h-75 justify-between p-2 shadow-xl rounded-xl hover:bg-green-300 scale-90 hover:scale-95">
              <img
                ...
                alt={movie.Title}
              />
              <h2 className="font-bold  text-green-700">Movie : {movie.Title}</h2>
              <p className="font-extrabold text-red-500">Year : {movie.Year}</p>
